...
#===========================================================================================================
"""train, evaluate, predict helper function"""
...
if __name__ == '__main__':
    ...
    args = get_args() #========> done: model, data, and training args
    ...
    if data_args.task_name.lower() == "superglue":
        ...
        from tasks.superglue.get_trainer import get_trainer #========> see next mark
